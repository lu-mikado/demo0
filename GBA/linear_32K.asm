;;  default's intel video card filter interpolation for IDirect3DSurface9 - RGB15 (Alpha empty) MASM32 - moecmks . 
;;  XXX: The performance of this filter is poor.
...
;; void __cdecl linear_32K (uint16_t *dstPtr, intptr_t dstPitch, 
